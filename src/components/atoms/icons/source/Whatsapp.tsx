...
const Whatsapp = ({ size = 12, color = "#800D0D", className }: IconProps) => {
    return (
        <svg className={className} fill={color} width={size} height={size} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
